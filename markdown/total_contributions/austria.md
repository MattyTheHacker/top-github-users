...
The `public contributions` and `private contributions` by users in Austria on `2022/6/16 11:16 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
...
<table>
	...
	<tr>
		<td>805</td>
		<td>
			<a href="https://github.com/NickSaliger">
				<img src="https://avatars.githubusercontent.com/u/4883116?s=72&u=b36e7e5dd782b066ca84d5077ef302c5f84da3db&v=4" width="24" alt="Avatar of NickSaliger"> NickSaliger
			</a><br/>
			Dominik Saliger
		</td>
		<td>No Company</td>
