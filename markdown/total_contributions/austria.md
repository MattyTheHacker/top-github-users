...
The `public contributions` and `private contributions` by users in Austria on `2022/6/26 8:14 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Traurige">
				<img src="https://avatars.githubusercontent.com/u/83172201?s=72&u=1e6b639e73b4125d39cb493db952fd8694ef202a&v=4" width="24" alt="Avatar of Traurige"> Traurige
			</a><br/>
			alexa
		</td>
		<td>No Company</td>
