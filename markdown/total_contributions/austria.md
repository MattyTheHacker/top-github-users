...
The `public contributions` and `private contributions` by users in Austria on `2022/8/9 9:14 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MauriceNino">
				<img src="https://avatars.githubusercontent.com/u/18658092?s=72&u=0dbf3b24b0342cf028122781e0e13a2f9633c5d2&v=4" width="24" alt="Avatar of MauriceNino"> MauriceNino
			</a><br/>
			Mauz
		</td>
		<td>Gepardec It Services Gmbh<br/></td>
		<td>No Twitter Username</td>
		<td>Linz, Austria</td>
		<td>760</td>
		<td>1028</td>
