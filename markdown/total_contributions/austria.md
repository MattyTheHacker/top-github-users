...
The `public contributions` and `private contributions` by users in Austria on `2022/7/18 5:32 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Traurige">
				<img src="https://avatars.githubusercontent.com/u/83172201?s=72&u=20d0c81f05efe02e88b0e73f1e9dd36c02916956&v=4" width="24" alt="Avatar of Traurige"> Traurige
			</a><br/>
			alexa
		</td>
		<td>No Company</td>
