...
The `public contributions` and `private contributions` by users in Austria on `2022/8/11 8:17 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Traurige">
				<img src="https://avatars.githubusercontent.com/u/83172201?s=72&u=dde0b5e09cde5fb4cddf18005939718086dea968&v=4" width="24" alt="Avatar of Traurige"> Traurige
			</a><br/>
			alexa
		</td>
		<td>No Company</td>
