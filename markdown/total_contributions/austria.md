...
The `public contributions` and `private contributions` by users in Austria on `2022/7/19 10:17 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
...
<table>
	...
	<tr>
		<td>835</td>
		<td>
			<a href="https://github.com/sigttou">
				<img src="https://avatars.githubusercontent.com/u/9093955?s=72&u=d0626d6eb068af7f3301223df5c705edbb594f7c&v=4" width="24" alt="Avatar of sigttou"> sigttou
			</a><br/>
			~sig
		</td>
		<td>No Company</td>
