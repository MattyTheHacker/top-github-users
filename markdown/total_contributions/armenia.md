...
The `public contributions` and `private contributions` by users in Armenia on `2022/7/11 2:17 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
