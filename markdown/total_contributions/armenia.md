...
The `public contributions` and `private contributions` by users in Armenia on `2022/7/6 5:27 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
