...
The `public contributions` and `private contributions` by users in Armenia on `2022/8/6 3:12 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
