...
The `public contributions` and `private contributions` by users in Armenia on `2022/10/3 8:19 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
