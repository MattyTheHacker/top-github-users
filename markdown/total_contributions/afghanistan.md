...
The `public contributions` and `private contributions` by users in Afghanistan on `2022/6/17 7:12 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
