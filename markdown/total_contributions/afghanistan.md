...
The `public contributions` and `private contributions` by users in Afghanistan on `2022/6/21 6:13 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
