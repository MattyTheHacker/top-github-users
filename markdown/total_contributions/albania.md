...
The `public contributions` and `private contributions` by users in Albania on `2022/8/27 11:12 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
