...
The `public contributions` and `private contributions` by users in Albania on `2022/7/14 3:14 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
