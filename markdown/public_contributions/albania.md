...
The `public contributions` by users in Albania on `2022/8/31 10:14 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

There are `9 countries` and `68 cities` can be found [here](https://github.com/MattyTheHacker/top-github-users).

There are `3290 users`  in Albania. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>399</td>
		<td>
			<a href="https://github.com/harli-lacej">
				<img src="https://avatars.githubusercontent.com/u/59536016?s=72&v=4" width="24" alt="Avatar of harli-lacej"> harli-lacej
			</a><br/>
			Harli Laçej
		</td>
		<td>No Company</td>
