...
The `public contributions` by users in Argentina on `2022/6/12 11:13 AM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ferantivero">
				<img src="https://avatars.githubusercontent.com/u/158487?s=72&v=4" width="24" alt="Avatar of ferantivero"> ferantivero
			</a><br/>
			Fernando Antivero
		</td>
		<td>@microsoft @mspnp @clariuslabs </td>
		<td><a href="https://twitter.com/ferantivero">ferantivero</a></td>
		<td>Buenos Aires, Argentina</td>
		<td>220</td>
	</tr>
	<tr>
