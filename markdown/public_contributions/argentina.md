...
The `public contributions` by users in Argentina on `2022/9/2 8:19 AM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
...
<table>
	...
	<tr>
		...
		<td>Bell Ville, Cordoba Argentina.</td>
		<td>1</td>
	</tr>
	<tr>
		<td>865</td>
