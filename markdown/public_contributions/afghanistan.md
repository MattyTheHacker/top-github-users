...
The `public contributions` by users in Afghanistan on `2022/8/3 11:13 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `9 countries` and `68 cities` can be found [here](https://github.com/MattyTheHacker/top-github-users).

There are `1755 users`  in Afghanistan. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>683</td>
		<td>
			<a href="https://github.com/Sharif2001">
				<img src="https://avatars.githubusercontent.com/u/34144696?s=72&v=4" width="24" alt="Avatar of Sharif2001"> Sharif2001
			</a><br/>
			S.h.p
		</td>
		<td>Ezipay </td>
