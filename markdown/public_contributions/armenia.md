...
The `public contributions` by users in Armenia on `2022/7/20 1:42 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
