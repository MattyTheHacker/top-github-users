...
The `number of followers` of users in Andorra on `2022/8/7 4:08 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
