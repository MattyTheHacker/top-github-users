...
The `number of followers` of users in Argentina on `2022/9/28 11:17 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
...
<table>
	...
	<tr>
		...
		<td>Clip.mx </td>
		<td><a href="https://twitter.com/d_hernan">d_hernan</a></td>
		<td>Buenos Aires, Argentina</td>
		<td>34</td>
	</tr>
</table>
